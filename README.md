...
I am a passionate **Senior SAP Developer** and **BTP Solution Architect** dedicated to building scalable, enterprise-grade applications. With extensive experience in **ABAP Cloud**, **RAP (RESTful ABAP Programming Model)**, and **SAP BTP**, I focus on delivering modern solutions that bridge the gap between business needs and technical excellence.

- 🔭 I’m currently working on **BTP Integration & Clean Core Extensibility**.
- 🌱 I’m also working on multiple POCs on **Generative AI in the SAP ecosystem**.
- 💬 Ask me about **SAP BTP, CAPM, RAP, and Cloud Native Development**.
- ⚡ Fun fact: I believe in the power of **Continuous Learning** and sharing knowledge through blogging.
...
### 🛡️ Verified Certifications & Badges (Active Only)
...
![ADT](https://img.shields.io/badge/SAP%20ADT-0faaff?style=for-the-badge&logo=sap&logoColor=white)
